...
from filters.AdminFilter import IsAdmin as AdminFilter
from filters.GroupFilter import IsGroup

from loader import dp, bot

@dp.message_handler(IsGroup(),Text(contains='bot'))
async def read_only_mode_bot(message: types.Message):
    ...
    try:
        ...
        await message.answer('Bot degan so\'zni ishlatdingiz 5 minutga yoza olmaysiz')
    except:
        print('admin bot deb yozdi')
